<div class="container-fluid">
  <form action="<?= base_url(); ?>index.php/user/pembayaran" enctype="multipart/form-data" method="post" accept-charset="utf-8">
  <section>
        ...
        <div class="card wish-list pb-1">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <!-- Grid column -->
              <div class="col-lg-12">
                <input type="hidden" class="form-control mb-0 mb-lg-2" id="id_sewa" name="id_sewa" value="<?= $bayar['id_sewa']; ?>">

                <input type="hidden" class="form-control mb-0 mb-lg-2" id="id_user" name="id_user" value="<?= $bayar['id_user']; ?>">

                <!-- First name -->
                <div class="md-form md-outline mb-0 mb-lg-4">
                  <label for="firstName">Jumlah Pembayaran</label>
                  <input type="text" class="form-control mb-0 mb-lg-2" id="jumlah" name="jumlah" value="<?= $bayar['jumlah_sewa']; ?>" readonly="">
                </div>
