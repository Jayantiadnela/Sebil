            ...
            <div class="row">
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user" method="POST" action="<?= base_url('index.php/auth/daftar');?>">
                            ...
                            <div class="form-group">
                                <input type="number" class="form-control form-control-user" id="nohp" name="nohp" placeholder="Masukkan Nomor HP..">
                        ...
                        <div class="text-center">
                            <a class="small" href="<?= base_url('index.php/auth'); ?>">Sudah ada akun? Login disini!</a>
                        </div>
                    </div>
                </div>
            </div>
